...
int init_yolov8_model(const char *model_path, rknn_app_context_t *app_ctx) {
    ...
    int set_core_ret = rknn_set_core_mask(ctx, core_mask);
    printf("set_core_ret=%d\n", set_core_ret);
    printf("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
...
int inference_yolov8_model(rknn_app_context_t *app_ctx, cv::Mat img, letterbox_t letter_box,
